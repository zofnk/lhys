...
public class SxzsFragment extends BaseFragment {
    private View view;
    ...
    protected View initViews(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            ...
            mHead.addView(inflater.inflate(R.layout.lhc_zsfx_table_title_sx, container, false));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.lhc_zsfx_table_data_sx, parent, false);
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            for (int i = 0; i < holder.textViews.length; i++) {
                ...
                if (i == 0) {
                    ...
                    holder.lins[i].setLayoutParams(new TableRow.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                            ViewGroup.LayoutParams.MATCH_PARENT));
                } else if (LiuheUtil.getSXid(str.get(2)) + 2 == i) {
                    textview.setText(str.get(2));
                    if (bsid == 0) {
...
//            });
    ...
    public void tableData() {
        ...
        for (int i = 0; i < mActivity.mDatas.size(); i++) {
            ...
            String sx = LiuheUtil.getSX_ft(mActivity.mDatas.get(i).getTmsx());
            list.add(sx);

            int sxid = LiuheUtil.getSXid(sx);
            str_title.set(sxid, (Integer.parseInt(str_title.get(sxid)) + 1) + "");
