...
public class BszsFragment extends BaseFragment {
    private View view;
    ...
    protected View initViews(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            ...
            mHead.addView(inflater.inflate(R.layout.lhc_zsfx_table_title_bs, container, false));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.lhc_zsfx_table_data_bs, parent, false);
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            for (int i = 0; i < holder.textViews.length; i++) {
                ...
                if (i == 0) {
                    ...
                    textview.setText(LiuheUtil.getRBG_string(str.get(1)));
                    if (bsid == 0) {
                    ...
                    holder.lins[i].setLayoutParams(new TableRow.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                            ViewGroup.LayoutParams.MATCH_PARENT));
                } else if (bsid + 2 + (dsid + 1) * 3 == i) {
                    textview.setText(i < 8 ? "單" : "雙");
                    if (bsid == 0) {
                        textview.setBackgroundResource(R.drawable.my_table_data_shape_yuan_red);
                    } else if (bsid == 1) {
                        textview.setBackgroundResource(R.drawable.my_table_data_shape_yuan_blue);
...
//            });
        ...
        class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            LinearLayout[] lins = new LinearLayout[11];
    ...
    public void tableData() {
        ...
        for (int i = 0; i < mActivity.mDatas.size(); i++) {
            ...
            int bsid = LiuheUtil.isRBG(mActivity.mDatas.get(i).getTm());
            int dsid = (Integer.parseInt(mActivity.mDatas.get(i).getTm()) + 1) % 2;
            str_title.set(bsid, (Integer.parseInt(str_title.get(bsid)) + 1) + "");
            str_title.set(bsid + (dsid + 1) * 3, (Integer.parseInt(str_title.get(bsid + (dsid + 1) * 3)) + 1) + "");
            str_data.add(list);
        }
