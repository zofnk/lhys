...
public class WszsFragment extends BaseFragment {
    private View view;
    ...
    protected View initViews(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            ...
            mHead.addView(inflater.inflate(R.layout.lhc_zsfx_table_title_ws, container, false));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.lhc_zsfx_table_data_ws, parent, false);
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            int wsid = Integer.parseInt(str.get(1)) % 10;
            for (int i = 0; i < holder.textViews.length; i++) {
                ...
                if (i == 0) {
                    ...
                    holder.lins[i].setLayoutParams(new TableRow.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                            ViewGroup.LayoutParams.MATCH_PARENT));
                } else if ((wsid < 5 && i == 12) || (wsid >= 5 && i == 13)) {
                    if (wsid < 5) {
                        textview.setText("小");
                    } else {
                        textview.setText("大");
...
//            });
        ...
        class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            LinearLayout[] lins = new LinearLayout[14];
            ...
            public MyViewHolder(View itemView) {
                ...
                textViews[9] = (TextView) itemView.findViewById(R.id.tv_10);
                textViews[10] = (TextView) itemView.findViewById(R.id.tv_11);
                textViews[11] = (TextView) itemView.findViewById(R.id.tv_12);
                textViews[12] = (TextView) itemView.findViewById(R.id.tv_13);
                textViews[13] = (TextView) itemView.findViewById(R.id.tv_14);
                ...
                lins[9] = (LinearLayout) itemView.findViewById(R.id.lin_10);
                lins[10] = (LinearLayout) itemView.findViewById(R.id.lin_11);
                lins[11] = (LinearLayout) itemView.findViewById(R.id.lin_12);
                lins[12] = (LinearLayout) itemView.findViewById(R.id.lin_13);
                lins[13] = (LinearLayout) itemView.findViewById(R.id.lin_14);
    ...
    public void tableData() {
        ...
        for (int i = 0; i < mActivity.mDatas.size(); i++) {
            ...
            int wsid = Integer.parseInt(mActivity.mDatas.get(i).getTm()) % 10;
            str_title.set(wsid, (Integer.parseInt(str_title.get(wsid)) + 1) + "");
            if (wsid < 5) {
                str_title.set(10, (Integer.parseInt(str_title.get(10)) + 1) + "");
            } else {
                str_title.set(11, (Integer.parseInt(str_title.get(11)) + 1) + "");
            }
            str_data.add(list);
        }
