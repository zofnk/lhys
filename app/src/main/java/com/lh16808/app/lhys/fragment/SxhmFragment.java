...
public class SxhmFragment extends Fragment implements SwipyRefreshLayout.OnRefreshListener {
    private View view;
...
//        mRecyclerView.addItemDecoration(new RecyclerViewDecoration(mActivity, LinearLayoutManager.VERTICAL));
    ...
    public static class ChangshiAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
            View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.lhc_cs_item_sx, null);
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
            ...
            holder.position = i;
            TextView[] textViews = {holder.tv_name, holder.tv_1, holder.tv_2, holder.tv_3,
                    holder.tv_4, holder.tv_5,};
            if (i != 0 & i % 13 == 0) {
        ...
        class PersonViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
            ...
            public View view;
            public TextView tv_name, tv_chong, tv_1, tv_2, tv_3, tv_4, tv_5, tv_6;
            public int position;
