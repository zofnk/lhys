...
public class DwzsFragment extends BaseFragment {
    private View view;
    ...
    protected View initViews(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            ...
            mHead.addView(inflater.inflate(R.layout.lhc_zsfx_table_title_dw, container, false));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.lhc_zsfx_table_data_dw, parent, false);
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            int dwid = (Integer.parseInt(str.get(1)) - 1) / 7;
...
//            });
    ...
    public void tableData() {
        ...
        for (int i = 0; i < mActivity.mDatas.size(); i++) {
            ...
            int dwid = (Integer.parseInt(mActivity.mDatas.get(i).getTm()) - 1) / 7;
            str_title.set(dwid, (Integer.parseInt(str_title.get(dwid)) + 1) + "");
