...
public class WxzsFragment extends BaseFragment {
    private View view;
    ...
    protected View initViews(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            ...
            mHead.addView(inflater.inflate(R.layout.lhc_zsfx_table_title_wx, container, false));
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(mContext).inflate(R.layout.lhc_zsfx_table_data_wx, parent, false);
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            for (int i = 0; i < holder.textViews.length; i++) {
                ...
                if (i == 0) {
                    ...
                    holder.lins[i].setLayoutParams(new TableRow.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                            ViewGroup.LayoutParams.MATCH_PARENT));
                } else if (LiuheUtil.getWXid(str.get(2)) + 3 == i) {
...
//            });
    ...
    public void tableData() {
        ...
        for (int i = 0; i < mActivity.mDatas.size(); i++) {
            ...
            String wx = LiuheUtil.getHaoma_WuXing(calendar, Integer.parseInt(mActivity.mDatas.get(i).getTm()));
            list.add(wx);

            int wxid = LiuheUtil.getWXid(wx);
            str_title.set(wxid, (Integer.parseInt(str_title.get(wxid)) + 1) + "");
